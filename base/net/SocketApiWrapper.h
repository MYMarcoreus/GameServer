...
SocketResult sendto(socket_t sockfd, const void *ptr, size_t nbytes, int flags, std::shared_ptr<IPAddress> peerAddr);
SocketResult recvfrom(socket_t sockfd, void *ptr, size_t nbytes, int flags, std::shared_ptr<IPAddress> peerAddr);

SocketResult readv(socket_t sockfd, IOV_TYPE *iov, int iovcnt);
SocketResult recvmsg(socket_t sockfd, IOV_TYPE *iov, int iovcnt, std::shared_ptr<IPAddress> peerAddr);

SocketResult writev(socket_t sockfd, IOV_TYPE *iov, int iovcnt);
SocketResult sendmsg(socket_t sockfd, IOV_TYPE *iov, int iovcnt, std::shared_ptr<IPAddress> peerAddr);
