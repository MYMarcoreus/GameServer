...
class FrontendServer final: public core::IServer{
...
public:
    FrontendServer(yy::net::EventLoop* accpetorLoop, const yy::net::IPAddressPtr& listenAddr);
    ~FrontendServer() override;

    /// @brief Start Listen & IOLoop
    virtual void Start(const net::F_ThreadInitCallback& cb) override;
