...
public:
    ...
    using F_Notifier = void (*)(const net::TcpConnectionPtr &, int32_t);
public:
    IServer() = default;
    ...
    virtual net::TcpConnectionPtr FindUserBySockfd(int sockfd) = 0;

    [[nodiscard]] virtual bool isRunning() const = 0;

    virtual net::TcpConnectionPtr getFreeUser(yy::net::Socket & sock) = 0;
    virtual void setUserFree(const net::TcpConnectionPtr& userdata) = 0;
