...
*/
class ProtobufTcpCodec_Cmd: public util::noncopyable {
...
public:
    explicit ProtobufTcpCodec_Cmd(const F_ProtobufMessageDispatchCallback& msgCb, const F_ProtobufErrorMessageCallback& errCb = DefaultErrorCallback);
...
private:
    ...
    std::pair<MessageHeader_Cmd, MessagePtr> Parse(const net::TcpConnectionPtr& conn, net::NetBuffer& buf, MessageParseErrorCode& outErrCode);
