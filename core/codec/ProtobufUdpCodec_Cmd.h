...
*/
class ProtobufUdpCodec_Cmd: public util::noncopyable {
...
public:
    explicit ProtobufUdpCodec_Cmd(F_ProtobufMessageDispatchCallback msgCb, F_ProtobufErrorMessageCallback errCb = DefaultErrorCallback);
...
private:
    ...
    std::pair<MessageHeader_Cmd, MessagePtr> Parse(const net::UdpSessionPtr& udpSession, net::NetBuffer& buf, MessageParseErrorCode& outErrCode);
